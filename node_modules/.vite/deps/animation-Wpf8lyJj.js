...
var standardProperty = (options = defaultPropertyDeclaration, target, context) => {
	...
	if (metadata == null) issueWarning$3("missing-class-metadata", `The class ${target} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`);
...
//#endregion
//#region node_modules/@material/web/internal/controller/attachable-controller.js
/**
* @license
...
var FOR_ATTRIBUTE_OBSERVER = new MutationObserver((records) => {
	for (const record of records) record.target[ATTACHABLE_CONTROLLER]?.hostConnected();
});
/**
...
//#endregion
//#region node_modules/@material/web/focus/internal/focus-ring.js
/**
* @license
* Copyright 2021 Google LLC
* SPDX-License-Identifier: Apache-2.0
...
var FocusRing = class extends LitElement {
	...
	update(changed) {
		if (changed.has("visible")) this.dispatchEvent(new Event("visibility-changed"));
...
//#endregion
//#region node_modules/@material/web/focus/internal/focus-ring-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@material/web/focus/md-focus-ring.js
/**
* @license
* Copyright 2021 Google LLC
* SPDX-License-Identifier: Apache-2.0
...
* @suppress {visibility}
*/
var MdFocusRing = class MdFocusRing extends FocusRing {};
MdFocusRing.styles = [styles];
MdFocusRing = __decorate([customElement("md-focus-ring")], MdFocusRing);
//#endregion
...
//#endregion
//#region node_modules/@material/web/internal/motion/animation.js
/**
* @license
* Copyright 2021 Google LLC
* SPDX-License-Identifier: Apache-2.0
...
//#endregion
export { property as C, __decorate as E, state as S, customElement as T, queryAssignedNodes as _, PartType as a, queryAll as b, AttachableController as c, html as d, mathml as f, svg as g, render as h, Directive as i, LitElement as l, nothing as m, createAnimationSignal as n, directive as o, noChange as p, classMap as r, MdFocusRing as s, EASING as t, _$LH as u, queryAssignedElements as v, css as w, query as x, queryAsync as y };

//# sourceMappingURL=animation-Wpf8lyJj.js.map